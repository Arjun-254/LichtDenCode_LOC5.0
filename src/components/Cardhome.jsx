      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
        ...
        <div>
          <div className="mt-10">
            ...
            <a href="#" className=" rounded-md border border-transparent bg-violet-600 py-3 px-6 font-medium text-white hover:bg-indigo-700">Get Started <span aria-hidden="true">&rarr;</span></a>
            </div>
          </div>
        </div>
      </div>
