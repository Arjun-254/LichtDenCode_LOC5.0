...
export default function Alert() {
  ...
  return (
   ...
   { isVisible && (
    ...
    <div className='flex justify-center absolute z-6 mt-16 ' style={{width: '100vw'}}>
    <div className="flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
    ...
    <div className="flex flex-wrap items-center gap-y-2 gap-x-4">
      ...
      <a href="#" className="flex-none rounded-full bg-gray-900 py-1 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">Register now <span aria-hidden="true">&rarr;</span></a>
    </div>
    <div className="flex flex-1 justify-end">
      <button type="button" className="-m-3 p-3 focus-visible:outline-offset-[-4px]" onClick={handleHideBanner}>
